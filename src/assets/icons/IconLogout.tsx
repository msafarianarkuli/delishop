function IconLogout({className}: {className: string}) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none">
      ...
      />
      <defs>
        <linearGradient id="logoutA" x1="9.541" x2="19.749" y1="8.834" y2="8.834" gradientUnits="userSpaceOnUse">
          <stop stopColor="#2C3036" />
          <stop offset=".54" stopColor="#575F6B" />
        </linearGradient>
        <linearGradient id="logoutB" x1=".374" x2="18.751" y1="8.5" y2="8.5" gradientUnits="userSpaceOnUse">
          <stop stopColor="#2C3036" />
          <stop offset=".54" stopColor="#575F6B" />
        </linearGradient>
      </defs>
