  ...
  return (
    <Link href={link} className={`w-full h-[220px] rounded-[10px] flex gap-4 relative ${color}`}>
      ...
      <div className="flex flex-col">
        <p className="text-textColor text-sm sm:text-xl font-bold mt-10 sm:mt-6 mb-4">
          <span>نام بازی: </span>
          <span>{name}</span>
        </p>
        <p className="text-textColor text-sm sm:text-xl font-bold">
          <span>امتیاز هر دست: </span>
          <span> 20</span>
        </p>
        <div className="absolute bottom-4 left-10">
          <p className="text-textColor text-sm sm:text-xl font-bold flex gap-3">
            <span>شروع بازی</span>
