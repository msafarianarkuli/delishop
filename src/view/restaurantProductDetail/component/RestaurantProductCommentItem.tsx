...
interface IRestaurantProductCommentItem {
  name: string;
  comment: string;
  date: string;
  star: number;
...
function RestaurantProductCommentItem(props: IRestaurantProductCommentItem) {
...
export default RestaurantProductCommentItem;
