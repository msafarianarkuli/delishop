import RestaurantProductCommentItem from "view/restaurantProductDetail/component/RestaurantProductCommentItem";

const arr = Array.from(new Array(5), (_, i) => i + 1);

function RestaurantProductDetailComment() {
  return (
    <div className="px-screenSpace mt-5">
      {arr.map((item) => {
        return (
          <div key={item} className="mb-5">
            <RestaurantProductCommentItem
              name="الناز"
...
export default RestaurantProductDetailComment;
